...
const receivingController_1 = require("../controllers/receivingController");
...
router.get('/receiving/recent', (0, auth_1.restrictTo)('admin', 'salesrep', 'storekeeper'), receivingController_1.getRecentReceiving);
router.post('/receiving', (0, auth_1.restrictTo)('admin', 'salesrep', 'storekeeper'), receivingController_1.recordReceiving);
